...
2. **Получение токенов** из поля `token` в коллекции ботов
3. **Валидация** наличия токенов для всех активных ботов
4. **Запуск ботов** только при наличии всех необходимых токенов
