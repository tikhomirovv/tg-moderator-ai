...
| **info** | Rare business events and lifecycle | app/DB startup, migrations OK, webhook set/remove, moderation outcome summary (rule + actions), user banned, workspace seed |
