...
--> statement-breakpoint
-- MVP: clear pre-auth domain rows before NOT NULL workspace_id
TRUNCATE TABLE chat_rules, chats, moderation_actions, user_messages, user_contexts, chat_statistics, bots, rules RESTART IDENTITY CASCADE;--> statement-breakpoint
ALTER TABLE "bots" ADD COLUMN "workspace_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "rules" ADD COLUMN "workspace_id" text NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "rules_workspace_id_unique" ON "rules" USING btree ("workspace_id","id");